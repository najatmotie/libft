...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/01/06 17:46:59 by nmotie-           #+#    #+#              #
#    Updated: 2024/02/17 16:36:50 by nmotie-          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_putendl_fd.c ft_putstr_fd.c ft_putchar_fd.c ft_substr.c ft_strjoin.c ft_strtrim.c ft_split.c ft_itoa.c \
